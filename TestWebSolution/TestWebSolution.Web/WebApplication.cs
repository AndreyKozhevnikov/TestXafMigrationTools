...
namespace TestWebSolution.Web {
    ...
    public partial class TestWebSolutionAspNetApplication : WebApplication {
        ...
        public TestWebSolutionAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void TestWebSolutionAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.securityStrategyComplex1.UserType = typeof(TestWebSolution.Module.BusinessObjects.ApplicationUser);
            //
            // securityModule1
            //
            this.securityModule1.UserType = typeof(TestWebSolution.Module.BusinessObjects.ApplicationUser);
            //
            ...
            this.authenticationStandard1.UserLoginInfoType = typeof(TestWebSolution.Module.BusinessObjects.ApplicationUserLoginInfo);
            //
            // auditTrailModule
            //
            ...
            //
            // TestWebSolutionAspNetApplication
            //
            this.ApplicationName = "TestWebSolution";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.TestWebSolutionAspNetApplication_DatabaseVersionMismatch);
