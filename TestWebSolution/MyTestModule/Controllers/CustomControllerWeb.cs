...
namespace dxTestSolution.Controllers {
    ...
    public class CustomWebController : ViewController {
        public CustomWebController() {
            var mypopAction1 = new PopupWindowShowAction(this, "MyWebPopupModuleAction1", null);
            mypopAction1.CustomizePopupWindowParams += MyAction1_CustomizePopupWindowParams;
            var myAction1 = new SimpleAction(this, "MyWebModuleAction1", PredefinedCategory.Edit);
